          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center px-6 py-2.5 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 text-lg"
              >
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                  ...
                  >
                    <div>
                      <div className="font-medium text-gray-900">Provider Data</div>
