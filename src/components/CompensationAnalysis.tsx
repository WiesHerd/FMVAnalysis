                ...
                <div className="relative">
                  ...
                  <div className="absolute top-0 w-full">
                    <div className="relative h-2">
                      ...
                      <div style={{ left: '25%' }} className="absolute w-0.5 h-2 bg-gray-300 print:bg-gray-400" />
                      <div style={{ left: '75%' }} className="absolute w-0.5 h-2 bg-gray-300 print:bg-gray-400" />
                      <div style={{ left: '90%' }} className="absolute w-0.5 h-2 bg-gray-300 print:bg-gray-400" />
                  ...
                  <div className="relative w-full mt-1">
                    ...
                    <div style={{ left: '25%' }} className="absolute transform -translate-x-1/2 text-xs text-gray-400 print:text-gray-600">25th</div>
                    <div style={{ left: '75%' }} className="absolute transform -translate-x-1/2 text-xs text-gray-400 print:text-gray-600">75th</div>
                    <div style={{ left: '90%' }} className="absolute transform -translate-x-1/2 text-xs text-gray-400 print:text-gray-600">90th</div>
              ...
              <div>
                ...
                <div className="relative">
                  <div className="overflow-hidden h-2 text-xs flex rounded bg-green-100 print:bg-green-50 print:border print:border-green-200">
                    <div
                      style={{ width: `${(getPercentilePosition(compensation.wrvus, 'wrvus') / 100) * 100}%` }}
                  ...
                  {/* Tick marks */}
                  <div className="absolute top-0 w-full flex justify-between px-0.5 -ml-0.5">
                    {benchmarks.map(b => (
                      <div key={b.percentile} className="w-0.5 h-2 bg-gray-300 print:bg-gray-400" />
                    ))}
                  </div>
                  <div className="grid grid-cols-6 text-xs text-gray-400 print:text-gray-600 mt-1">
                    {benchmarks
                      .slice()
                      .map(b => (
                        <div key={b.percentile} className="text-center">{b.percentile}</div>
                      ))}
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <div className="overflow-hidden h-2 text-xs flex rounded bg-purple-100 print:bg-purple-50 print:border print:border-purple-200">
                    <div
                      style={{ width: `${(getPercentilePosition(compensation.perWrvu, 'conversionFactor') / 100) * 100}%` }}
